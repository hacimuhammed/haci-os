...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col">
      {/* Hero Bölümü */}
      <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-black to-zinc-900 text-white">
        ...
        <div className="container relative z-10 px-4 md:px-6 flex flex-col items-center text-center space-y-8">
          <div className="space-y-2">
            ...
            <p className="text-xl md:text-2xl text-zinc-400 max-w-3xl mx-auto mt-4">
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-8">
            <Button
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-violet-600 hover:opacity-90 transition-all"
            >
              Şimdi Deneyin
            </Button>
            <Button
              variant="outline"
              size="lg"
              className="bg-zinc-900/60 border-zinc-700 text-white hover:bg-zinc-800/70 backdrop-blur-sm"
            >
              Daha Fazla Bilgi
            </Button>
          </div>
      ...
      <section className="py-24 bg-zinc-950 text-white">
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 p-6 rounded-xl border border-zinc-800 hover:border-zinc-700 transition-all">
            ...
            <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 p-6 rounded-xl border border-zinc-800 hover:border-zinc-700 transition-all">
              <div className="bg-violet-500/10 p-3 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
            ...
            <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 p-6 rounded-xl border border-zinc-800 hover:border-zinc-700 transition-all">
              <div className="bg-sky-500/10 p-3 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
                <LucideServer className="text-sky-500" size={24} />
              </div>
              <h3 className="text-xl font-semibold mb-2">Web Tabanlı</h3>
              <p className="text-zinc-400">
            ...
            <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 p-6 rounded-xl border border-zinc-800 hover:border-zinc-700 transition-all">
              <div className="bg-emerald-500/10 p-3 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
            ...
            <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 p-6 rounded-xl border border-zinc-800 hover:border-zinc-700 transition-all group">
              <div className="p-6 text-center flex flex-col items-center justify-center h-full">
                <p className="text-xl font-semibold mb-2 text-zinc-300">
                  Ve daha fazlası...
                </p>
                <Button
                  variant="ghost"
                  className="text-blue-400 group-hover:text-blue-300 group-hover:underline"
                >
      ...
      <section className="py-24 relative overflow-hidden bg-gradient-to-b from-zinc-950 to-black">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Button
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-violet-600 hover:opacity-90 transition-all px-6"
            >
              Hemen Başlayın
            </Button>
          </div>
      ...
      {/* Footer */}
      <footer className="py-12 bg-black text-zinc-500 border-t border-zinc-900">
        <div className="container px-4 md:px-6">
